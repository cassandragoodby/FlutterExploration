...
//SHOW ERROR MESSAGE FIX, restrict space bar and tab 
  Widget _showErrorMessage() {
  // if (_errorMessage.length > 0 && _errorMessage != null) { error message cant call length
